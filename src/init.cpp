...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/yugionacoin-project/yugionacoin>";
    const std::string URL_WEBSITE = "<https://yugionacoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Yugionacoin version %s\n", FormatFullVersion());
}
