...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s yugionacoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  yugionacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded yugionacoin transaction") + "\n" +
              "  yugionacoin-tx [options] -create [commands]   " + _("Create hex-encoded yugionacoin transaction") + "\n" +
              "\n";
