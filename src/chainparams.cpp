...
{
    const char* pszTimestamp = "yugiona blockchain is my main start project launched at OCT 17 in 2020";
    const CScript genesisOutputScript = CScript() << ParseHex("078584710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
*/
        ...
        nPruneAfterHeight = 100000;
         ...
         genesis = CreateGenesisBlock(1602925736, 2002838342, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("b1c673fa103028ca30ac2cfd0abd6a2f8156304e79ddb1b5eeafd043231aa4a6"));
        assert(genesis.hashMerkleRoot == uint256S("09c3b054f2ea6963e52c3ad2f82ef1d79582a60c16cfe3526aec8f278251f5bd"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("18.224.136.90", "18.224.136.90", true));
      ...
      //  vSeeds.push_back(CDNSSeedData("koin-project.com", "dnsseed.koin-project.com"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("b1c673fa103028ca30ac2cfd0abd6a2f8156304e79ddb1b5eeafd043231aa4a6"))
        ...
        chainTxData = ChainTxData{
            ...
            1602925736, // * UNIX timestamp of last known number of transactions
    ...
    CTestNetParams() {
     ...
     /*   consensus.BIP34Height = 76;
        ...
        */
        ...
        genesis = CreateGenesisBlock(1602925736, 122566, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("bf99af9a3211d85a71758c91f9348530a72db7fd82498fba9c5da8a5cd8b7db2"));
        assert(genesis.hashMerkleRoot == uint256S("09c3b054f2ea6963e52c3ad2f82ef1d79582a60c16cfe3526aec8f278251f5bd"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("18.224.136.90", "18.224.136.90"));
      ...
      checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("bf99af9a3211d85a71758c91f9348530a72db7fd82498fba9c5da8a5cd8b7db2")),
        };
...
*/
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("6fb4d10780e06df67432719005dc00552003d9b6dd4d197f74b4bbece1c93356"));
        assert(genesis.hashMerkleRoot == uint256S("09c3b054f2ea6963e52c3ad2f82ef1d79582a60c16cfe3526aec8f278251f5bd"));
        ...
        fMineBlocksOnDemand = true; 
         ...
         checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("6fb4d10780e06df67432719005dc00552003d9b6dd4d197f74b4bbece1c93356"))
        };
