...
{
    const char* pszTimestamp = "yugiona blockchain beta is my main start project launched at OCT 27 in 2020 by c";
    const CScript genesisOutputScript = CScript() << ParseHex("071084710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 1051200; //consensus.nSubsidyHalvingInterval = 840000;
...
*/
        ...
        nPruneAfterHeight = 100000;
         ...
         genesis = CreateGenesisBlock(1603765253, 2000820589, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("7bae20965b325a241ee6885516923594067e9f8d24433e6b8353719fb7b1c848"));
        assert(genesis.hashMerkleRoot == uint256S("b5d85fd6284af1415792f2296384979d60cb83aff174fc228f743297d8013701"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("18.188.107.92", "18.188.107.92", true));
      //  vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
      //  vSeeds.push_back(CDNSSeedData("yugionacointools.com", "dnsseed.yugionacointools.com"));
      //  vSeeds.push_back(CDNSSeedData("yugionacoinpool.org", "dnsseed.yugionacoinpool.org"));
      //  vSeeds.push_back(CDNSSeedData("koin-project.com", "dnsseed.koin-project.com"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("7bae20965b325a241ee6885516923594067e9f8d24433e6b8353719fb7b1c848"))
        ...
        chainTxData = ChainTxData{
            ...
            1603765253, // * UNIX timestamp of last known number of transactions
    ...
    CTestNetParams() {
     ...
     /*   consensus.BIP34Height = 76;
        ...
        */
        ...
        genesis = CreateGenesisBlock(1603765253, 612073, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("afacbeec226ba6a8583a26b4f6535986624e29c38475b4f7a05318a51a602635"));
        assert(genesis.hashMerkleRoot == uint256S("b5d85fd6284af1415792f2296384979d60cb83aff174fc228f743297d8013701"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("18.188.107.92", "18.188.107.92"));
       /* vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.yugionacoin.loshan.co.uk", true));
      ...
      checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("afacbeec226ba6a8583a26b4f6535986624e29c38475b4f7a05318a51a602635")),
        };
...
*/
        ...
        genesis = CreateGenesisBlock(1603765253, 0, 0x207fffff, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();        
        assert(consensus.hashGenesisBlock == uint256S("96022406d52936157e4bd28b3bb3941f0ae89ba239f2ec22c9331d810f12f446"));
        assert(genesis.hashMerkleRoot == uint256S("b5d85fd6284af1415792f2296384979d60cb83aff174fc228f743297d8013701"));
        ...
        fMineBlocksOnDemand = true; 
         ...
         checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("96022406d52936157e4bd28b3bb3941f0ae89ba239f2ec22c9331d810f12f446"))
        };
